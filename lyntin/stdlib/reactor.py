...
## ok, how?  everybody's got an active set list, you add actions/aliases to one set
## at a time, there is one default set.
##
## new way to handle actions -- if a line is partially completed, check triggers,
## if any of them hit, take the ones that hit off
## the list to check when the line completes.  when it completes, check the
## unspent triggers, then restore them all.
##
